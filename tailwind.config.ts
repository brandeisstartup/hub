...
module.exports = {
  ...
  theme: {
    ...
    colors: ({ colors }) => ({
      BrandeisBrandShade: "#071C3E",
      BrandeisBrand: "#003478",
      BrandeisBrandGray: "#e8e8e8",
      BrandeisBodyText: "#2e2e2e",
      BrandeisBackgroundAlt: "#f5f4f0",
      IBSbrand: "#008383",
      IBStint: "#66cccc",
      IBSShade: "#005959;",
      myGreen1: "#DDF0E7",
    ...
    fontSize: {
      ...
      body: ["1.2rem", { lineHeight: "2.25rem" }],
